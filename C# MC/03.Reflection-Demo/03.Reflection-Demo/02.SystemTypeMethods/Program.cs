namespace SystemTypeMethods
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            //Console.WriteLine(string.Join(" ", arrayType.GetInterfaces().ToList()));
            ...
            PropertyInfo[] properties = personType.GetProperties(BindingFlags.Instance | BindingFlags.Public |BindingFlags.NonPublic);
            ...
            ConstructorInfo[] constructors = personType.GetConstructors(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
