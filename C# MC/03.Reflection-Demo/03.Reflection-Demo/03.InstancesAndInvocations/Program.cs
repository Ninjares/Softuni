namespace InstancesAndInvocations
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            var fieldName = personType.GetField("age", BindingFlags.Instance | BindingFlags.NonPublic);
            fieldName.SetValue(instance, 42);
            Console.WriteLine(fieldName.GetValue(instance));
            Console.WriteLine(typeof(Person).GetMethod("ToString").Invoke(instance, null));
