namespace GenericsDemo
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            personType.GetMethod("WhoAmI")?.MakeGenericMethod(typeof(string)).Invoke(personInstance, new object[] { "Bumpa" });

            Console.WriteLine(genericType.FullName);
            Console.WriteLine(personType.GetMethod("GetT")?.MakeGenericMethod(typeof(string)).Invoke(personInstance, new object[] { "Bumpa" }));
            Console.ReadKey();
